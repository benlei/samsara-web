...
export default function DynamicSummaryPage({ star, type, featuredList, date }: PageProps) {
  const title = getPageTitle(star, type, "summary");
  const heading = getPageHeading(star, type, "summary");
