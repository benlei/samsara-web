...
export default function DynamicSummaryAvgPage({ star, type, featuredList }: PageProps) {
  const title = getPageTitle(star, type, "summary-avg");
  const heading = getPageHeading(star, type, "summary-avg");
