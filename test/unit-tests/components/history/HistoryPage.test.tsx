...
// Mock HistoryPage component's dependencies
...
describe('HistoryPage Component', () => {
  ...
  it('renders drag scroll container with correct styling', () => {
    render(<HistoryPage {...defaultProps} />);

    // The drag scroll container should be a Box with the banner table inside
    const bannerTable = screen.getByTestId('mock-banner-table');
    expect(bannerTable).toBeInTheDocument();
    
    // The container should have drag scroll functionality
    const container = bannerTable.closest('[style*="cursor"]');
