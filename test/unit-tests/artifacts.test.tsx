import {ArtifactsDomainsData} from "@/artifacts/types";
...
describe('getArtifacts()', () => {
    it('should have same number of elements as input', async () => {
        const artifactsDomainsData: ArtifactsDomainsData = require('@/data/artifacts.json')
...
describe('getArtifactDomains()', () => {
    it('should have same number of elements as input', async () => {
        const artifactsDomainsData: ArtifactsDomainsData = require('@/data/artifacts.json')
        const artifactDomains = getArtifactDomains(artifactsDomainsData)

        expect(Object.keys(artifactDomains)).toEqual(Object.keys(artifactsDomainsData.domains))
    });
    ...
    it('should have Clear Pool and Mountain Cavern', async () => {
        ...
        expect(artifactDomains["Clear Pool and Mountain Cavern"]).toEqual({
