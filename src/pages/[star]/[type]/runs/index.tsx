...
export default function DynamicRunsPage({ star, type, featuredList }: PageProps) {
  const title = getPageTitle(star, type, "runs");
  const heading = getPageHeading(star, type, "runs");
