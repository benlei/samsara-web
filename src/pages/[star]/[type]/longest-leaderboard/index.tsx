...
export default function DynamicLongestLeaderboardPage({ star, type, featuredList, date }: PageProps) {
  const title = getPageTitle(star, type, "longest-leaderboard");
  const heading = getPageHeading(star, type, "longest-leaderboard");
