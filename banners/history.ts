import {BannerDataset, BannerHistoryDataset, Featured, FeaturedHistory} from "@/banners/types";
...
export default function LoadDataset(): BannerHistoryDataset {
    const dataset = YAML.parse(fs.readFileSync(path.resolve('./public/data/banners.yaml'), 'utf8')) as BannerDataset
